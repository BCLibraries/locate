 ...
 */
final class Version20210212190254 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE map (id INT AUTO_INCREMENT NOT NULL, library_id INT NOT NULL, code VARCHAR(24) NOT NULL, label VARCHAR(255) NOT NULL, image_original_filename VARCHAR(255) NOT NULL, image_filename VARCHAR(255) NOT NULL, INDEX IDX_93ADAABBFE2541D7 (library_id), UNIQUE INDEX code_unique (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
